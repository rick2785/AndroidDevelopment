package dev.hrabowskie.fortuneball;
...
public class MainActivity extends AppCompatActivity {
    ...
    String fortuneList[] = {"Don't count on it", "Ask again Later", "You may rely on it", "Without a doubt",
            "Outlook not so good", "It's decidedly so", "Signs point to yes", "Yes definitely", "My sources say NO"};
